window.DASH_DATA = {
 ...
 "prediction": {
  ...
  "bulls": [
   "**动能强劲**：上周 +5.6% 收三个月新高（FXStreet）；周五单日 +1.69%，技术形态突破，分析师上看 $4,891（Bruce Powers）；今早跳空高开，现价",
   "**央行购金**：PBOC 6 月增持 15 吨（2023 年 10 月以来最大单月），连续 21 个月增持，官方持仓 7,608 万盎司；全球央行结构性买入推升金价至历史高位（S",
   "**地缘避险**：霍尔木兹海峡航运量降约 90%，美伊停火脆弱，避险底仓稳固",
   "**降息押注升温**：9 月按兵不动概率 68%→60%（FXStreet），美元趋弱利多黄金"
  ],
  "bears": [
   "**连涨后回调**：单周 +5.6%、今早再跳空 +0.87%，获利了结压力客观存在",
 ...
 "history": [
  {
   ...
   "actual": null,
   "pct": null,
   "adir": "=IF(J3=\"\",\"\",IF(J3>0,\"涨\",IF(J3<0,\"跌\",\"平\")))",
   "aband": "=IF(J3=\"\",\"\",IF(ABS(J3)<=0.003,\"小\",IF(ABS(J3)<=0.01,\"中\",\"大\")))",
   "dok": "=IF(OR(D3=\"\",K3=\"\"),\"\",IF(D3=K3,\"√\",\"×\"))",
   "bok": "=IF(OR(E3=\"\",L3=\"\"),\"\",IF(E3=L3,\"√\",\"×\"))",
   "regime": "趋势涨(20日+12.66%)",
   "drivers": "动能延续(上周+5.6%创三个月新高,今早跳空高开)+央行购金(PBOC 6月+15t连买21月)+霍尔木兹避险(航运-90%)+9月降息押注升温；风险:美元走强/连涨后获利回吐/VIX回落15.1"
  },
  {
 ...
 "news": [
  {
   ...
   "items": [
    {
     "t": "Gold Analysis Today: XAU/USD Support and Resistance Levels",
     "u": "https://tradersunion.com/analytics/view/xau-usd"
    },
    {
